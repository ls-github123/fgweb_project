    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
                ('updated_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('link', models.CharField(max_length=100, verbose_name='导航连接')),
                ('is_http', models.BooleanField(default=False, verbose_name='是否为外部连接')),
                ('postion', models.ImageField(choices=[(0, '顶部导航'), (1, '底部导航')], default=0, upload_to='', verbose_name='导航位置区分')),
            ],
            options={
                'verbose_name': '导航菜单',
