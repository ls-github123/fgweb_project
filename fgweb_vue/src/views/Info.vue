        ...
        <div class="course-content">
          <div class="course-tab-list">
            ...
            <div class="tab-item" v-if="course.tabIndex===2">
              ...
              <div class="chapter-item" v-for="chapter in course.chapter_list" :key="chapter.id">
                ...
                <ul class="lesson-list">
                  <li class="lesson-item"  v-for="lesson in chapter.get_lesson_list" :key="lesson.id">
                    <p class="name">
          ...
          <div class="course-side">
             <div class="teacher-info">
               ...
               <div class="teacher-content">
                 <div class="cont1">
                   <img style="border-radius: 50%;" :src="course.info.teacher.avatar">
                   <div class="name">
...
if(course.course_id > 0){
  course.get_course()
  console.log('-----------------');
  console.log(course.info.students);
  // 活动到计算
...
// 添加商品课程到购物车
const add_course_to_cart = ()=>{
   let token = sessionStorage.access_token || localStorage.access_token;
   cart.add(course.course_id, token).then(response=>{
    console.log('添加购物车成功...');
