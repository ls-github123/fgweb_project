        ...
        <div class="content">
          ...
          <div class="search-warp">
            <div class="search-area">
              <input class="search-input" placeholder="请输入关键字..." v-model="course.text" type="text" autocomplete="off">
              <div class="hotTags">
                <a href="" @click.prevent.stop="search_course(hot_word)" v-for="hot_word in course.hot_word_list" :key="hot_word">{{hot_word}}</a>
              </div>
            </div>
            <div class="showhide-search" data-show="no" @click="search_course(course.text)"><img class="imv2-search2" src="../assets/search.svg" /></div>
          </div>
          <div class="login-bar logined-bar"  v-if="store.getters.getUserInfo.user_id">
            <div class="shop-cart ">
            ...
            <div class="login-box ">
              ...
              <el-dropdown>
                <span class="el-dropdown-link">
                  <el-avatar class="avatar" size="50" :src="`${store.getters.getUserInfo.avatar}`"></el-avatar>
                </span>
                <template #dropdown>
                  <el-dropdown-menu>
                    <el-dropdown-item :icon="UserFilled"><router-link to="/user">学习中心</router-link></el-dropdown-item>
                    <el-dropdown-item :icon="Trophy"><router-link to="/user/course">我的课程</router-link></el-dropdown-item>
                    <el-dropdown-item :icon="List"><router-link to="/user/order">我的订单</router-link></el-dropdown-item>
                    <el-dropdown-item :icon="Money"><router-link to="/user/coupon">我的优惠券</router-link></el-dropdown-item>
                    <el-dropdown-item :icon="Setting"><router-link to="/user/settings">我的设置</router-link></el-dropdown-item>
...
<script setup>
import {UserFilled, List, Setting, Position, Money, Trophy} from '@element-plus/icons-vue'
...
const search_course = (hotword)=>{
  console.log('-----------页面跳转---------');
  course.text = hotword;
  course.search_course();
  
  router.push(`/project?word=${course.text}`)
}
